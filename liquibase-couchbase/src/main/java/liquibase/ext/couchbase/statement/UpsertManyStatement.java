...
public class UpsertManyStatement extends CouchbaseTransactionStatement {
    ...
    @Override
    public void doInTransaction(ReactiveTransactionAttemptContext context, ClusterOperator clusterOperator) {
        ...
        clusterOperator.getBucketOperator(keyspace.getBucket()).getCollectionOperator(keyspace.getCollection(),
                keyspace.getScope()).upsertDocsTransactionally(context, contentList);
    }
