...
class RemoveDocumentsSqlPlusPlusQueryStatementTest {
    ...
    void Should_execute_in_transaction() {
        ...
        ids.add(new Id("id"));
        String sqlPlusPlusQuery = "sqlPlusPlusQuery";
        RemoveDocumentsSqlPlusPlusQueryStatement statement = new RemoveDocumentsSqlPlusPlusQueryStatement(TEST_KEYSPACE, ids,
                sqlPlusPlusQuery);
